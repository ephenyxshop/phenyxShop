...
class AdminStockManagementControllerCore extends AdminController {
     ...
     * @since 1.9.1.0
     */
    public function displayAddstockLink($id, $token = null) {
     ...
     * @since 1.9.1.0
     */
    public function displayRemovestockLink($id ,$token = null) {
     ...
     * @since 1.9.1.0
     */
    public function displayTransferstockLink($id, $token = null) {
     ...
     * @since 1.9.1.0
     */
    public function displayPrepareRemovestockLink($id, $token = null) {
     ...
     * @since 1.9.1.0
     */
    public function displayPrepareTransferstockLink($id, $token = null) {
