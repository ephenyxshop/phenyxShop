...
class ParentOrderControllerCore extends FrontController {
    ...
    public function init() {
        ...
        if (Tools::isSubmit('submitReorder') && $idOrder = (int) Tools::getValue('id_order')) {
            $oldCart = new Cart(CustomerPieces::getCartIdStatic($idOrder, $this->context->customer->id));
        ...
        if ($this->nbProducts) {
            ...
            if (CartRule::isFeatureActive()) {
                ...
                } else if (($idCartRule = (int) Tools::getValue('deleteDiscount')) && Validate::isUnsignedId($idCartRule)) {
