...
class ConfigurationTestCore {
    ...
    public static function testDir($dir, $recursive = false, &$fullReport = null, $absolute = false) {
        ...
        if ($absolute) {
            ...
            $absoluteDir = rtrim(_EPH_ROOT_DIR_, '\\/') . DIRECTORY_SEPARATOR . trim($dir, '\\/');
        }
    ...
    public static function testFile($fileRelative, &$report = null) {
        ...
        $file = _EPH_ROOT_DIR_ . DIRECTORY_SEPARATOR . $fileRelative;
    ...
    public static function testFiles($full = false) {
        ...
        foreach (static::$testFiles as $file) {
            ...
            if (!file_exists(rtrim(_EPH_ROOT_DIR_, DIRECTORY_SEPARATOR) . str_replace('/', DIRECTORY_SEPARATOR, $file))) {
